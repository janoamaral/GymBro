# completed-set-values Spec

## Purpose

Permite registrar y persistir por cada `ExerciseSet` los valores efectivamente ejecutados (`repsDone`, `weightDone`), editarlos vía modal y exponerlos en la card del set.
